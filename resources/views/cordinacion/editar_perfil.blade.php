...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="{{url('/perfil')}}">Pefil</a>
        </li>
        <li class="active">Editar Pefil</li>
    </ul>
				...
				<div class="widget-box transparent">
					...
					<div class="widget-body">
						<div class="widget-main padding-24">
							<div class="row">
								<form id="register_frm" role="form" method="POST" action="{{ url('/perfil/tutoe/editar/') }}">
                                    {{ csrf_field() }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="cedula" name="cedula" value="{{$persona->cedula}}" class="form-control" placeholder="Cedula" disabled />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('fecha_nacimento') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="date" id="fecha_nacimento" name="fecha_nacimento" value="{{ $persona->fecha_nacimento }}" class="form-control" placeholder="Fecha de Nacimiento" autofocus/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('primer_nombre') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="primer_nombre" name="primer_nombre" value="{{ $persona->primer_nombre }}" class="form-control" placeholder="Primer nombre" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('segundo_nombre') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="segundo_nombre" name="segundo_nombre" value="{{ $persona->segundo_nombre }}" class="form-control" placeholder="Segundo nombre" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('primer_apellido') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="primer_apellido" name="primer_apellido" value="{{ $persona->primer_apellido }}" class="form-control" placeholder="Primer apellido" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('segundo_apellido') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="segundo_apellido" name="segundo_apellido" value="{{ $persona->segundo_apellido }}" class="form-control" placeholder="Segundo apellido" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('telefono_uno') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="telefono_uno" name="telefono_uno" value="{{ $persona->telefono_uno }}" class="form-control" placeholder="Teléfono" />
