...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <form id="aperturar_inscripciones" class="form-horizontal" role="form" method="POST" action="{{ url('/cronograma-pasantias') }}"">
            {{ csrf_field() }}
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('periodo') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="periodo" type="text" class="form-control" name="periodo" placeholder="Periodo" value="{{ old('periodo') }}" autofocus>
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('primera_charla') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="primera_charla" type="date" class="form-control" name="primera_charla" value="{{ old('primera_charla') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('segunda_charla') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="segunda_charla" type="date" class="form-control" name="segunda_charla" value="{{ old('segunda_charla') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('ini_pasantias') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="ini_pasantias" type="date" class="form-control" name="ini_pasantias" value="{{ old('ini_pasantias') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('entrega_req_inic') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="entrega_req_inic" type="date" class="form-control" name="entrega_req_inic" value="{{ old('entrega_req_inic') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('primera_visita') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="primera_visita" type="date" class="form-control" name="primera_visita" value="{{ old('primera_visita') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('reasignacion') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="reasignacion" type="date" class="form-control" name="reasignacion" value="{{ old('reasignacion') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('segunda_visita') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="segunda_visita" type="date" class="form-control" name="segunda_visita" value="{{ old('segunda_visita') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('culminacion_pasantias') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="culminacion_pasantias" type="date" class="form-control" name="culminacion_pasantias" value="{{ old('culminacion_pasantias') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('desde_entrega_req_fina') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="desde_entrega_req_fina" type="date" class="form-control" name="desde_entrega_req_fina" value="{{ old('desde_entrega_req_fina') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('hasta_entrega_req_fina') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="hasta_entrega_req_fina" type="date" class="form-control" name="hasta_entrega_req_fina" value="{{ old('hasta_entrega_req_fina') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('desde_presentacion_oral') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="desde_presentacion_oral" type="date" class="form-control" name="desde_presentacion_oral" value="{{ old('desde_presentacion_oral') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('hasta_presentacion_oral') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="hasta_presentacion_oral" type="date" class="form-control" name="hasta_presentacion_oral" value="{{ old('hasta_presentacion_oral') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('carga_notas') ? ' has-error' : '' }}">
                        <div class="col-md-12">
                            ...
                            <input id="carga_notas" type="date" class="form-control" name="carga_notas" value="{{ old('carga_notas') }}">
...
<script type="text/javascript">
    ...
    frm.addEventListener('submit', function  (e) {
        ...
        let primera_charla = new Date(frm.primera_charla.value), 
            ...
            segunda_charla = new Date(frm.primera_visita.value);    
