...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Solicitar Pasante</li>
    </ul>

</div>

<div class="page-header">
	<h2>Solicitar Pasante</h2>
</div>
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <form id="solicitud_frm" role="form" method="POST" action="{{ url('/solicitud/nueva') }}">
            {{ csrf_field() }}
            <fieldset>
                        ...
                        <div class="form-group{{ $errors->has('cantidad') ? ' has-error' : '' }}">
                            <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" id="cantidad" name="cantidad" value="{{ old('cantidad') }}" class="form-control" placeholder="Cantidad de pasantes" autofocus />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group{{ $errors->has('descripcion') ? ' has-error' : '' }}">
                            <label class="block clearfix">
                                <span class="block input-icon input-icon-right">
                                    <textarea id="descripcion" type="text" class="form-control" name="descripcion" placeholder="Descripción de la solicitud">{{ old('descripcion') }}</textarea>
                ...
                <div class="clearfix">
                    ...
                    <button type="submit" data-btn="btn" class="width-60 pull-right btn btn-sm btn-primary">
                        <span class="bigger-110">Solicitar Pasantes</span>
