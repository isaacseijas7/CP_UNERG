				...
				<div class="widget-box transparent">
					...
					<div class="widget-body">
						<div class="widget-main padding-24">
							<div class="row">
								<form id="register_frm" role="form" method="POST" action="{{ url('/empresas/registrar') }}">
                                    {{ csrf_field() }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('correo') ? ' has-error' : '' }}">
		                                            <label class="block clearfix">
		                                                <span class="block input-icon input-icon-right">
		                                                    <input type="email" id="correo" name="correo" value="{{ old('correo') }}" class="form-control" placeholder="Correo" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" id="direccion" name="direccion" value="{{ old('direccion') }}" class="form-control" placeholder="Descripción" />
