...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        @if (Auth::user()->type=='Admin')
            <li>
                <a href="{{ url('/pasantes') }}">Pasantes</a>
            </li>
        @endif

        @if (Auth::user()->type=='Empresa')
            <li>
                <a href="{{ url('/pasantes-apectados') }}">Pasantes</a>
            </li>
        @endif

        <li class="active">Ver Pasante</li>
    </ul>
            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="widget-box transparent">
                    <div class="widget-header widget-header-large">
                        <h2><i class="ace-icon fa fa-user"></i> Datos Pasante</h2>
                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <ul class="list-unstyled  spaced">
                                            ...
                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i><b>Trabaja:</b> {{$pasante->pasante->trabaja}}
                                            </li>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div>
                                            <ul class="list-unstyled  spaced">
                                                ...
                                                <li>
                                                    <i class="ace-icon fa fa-caret-right green"></i><b>Email:</b> {{$tutorAcade->email}}
                                                </li>
