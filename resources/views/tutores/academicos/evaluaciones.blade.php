...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="frm" action="{{url('/evaluaciones/academicas')}}" method="POST">
                {{ csrf_field() }}
                <div class="row">
                ...
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 400px;">Asistencia y puntualidad: el cumplimiento de las
actividades.</td>
...
mejorar prácticas o procedimientos.</td>
                            ...
                            <tr>
                                <td>Creatividad: aporte original de soluciones producidas por
...
sometidos a su análisis.</td>
                            ...
                            <tr>
                                <td>Responsabilidad: en la entrega oportuna de las tareas
encomendadas.</td>
                                <td style="text-align: center;" title="Muy mal" >
                            ...
                            <tr>
                                <td>Presentación: Capacidad de demostrar pulcritud y buena
presencia dentro de la empresa.</td>
                            ...
                            <tr>
                                <td>Adaptabilidad: capacidad de adaptase a situaciones
...
con efectividad.</td>
                            ...
                            <tr>
                                <td>Participación: es el grado en que el pasante se identifica
con el trabajo, participando con entusiasmo en el mismo.</td>
                            ...
                            <tr>
                                <td>¿Sapiente itaque dolorem vitae voluptate quisquam tenetur repudiandae veniam odit similique quia!?</td>
                                <td style="text-align: center;" title="Muy mal" >
