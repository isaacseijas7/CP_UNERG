...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Ver Tutor Academico</li>
    </ul>
                ...
                <div class="widget-box transparent">
                    ...
                    <div class="widget-body">
                        <div class="widget-main padding-24">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <ul class="list-unstyled spaced">
                                            ...
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i> <b>Dirección</b> {{$tutor->direccion}}
                                            </li>
                                        </ul>
                                    </div>
                                </div><!-- /.col -->
                            ...
                            <a class="btn btn-xl btn-success" href=" {{url('tutores-academicos/editar/')}}/{{$tutor->id}} "><i class="ace-icon fa fa-pencil bigger-120"></i> Editar</a>
